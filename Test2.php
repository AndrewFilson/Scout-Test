...
$query_Recordset1 = "SELECT scouts.name, badges.badge_name FROM scouts, badges WHERE badges.sid=scouts.sid AND badges.completed = 'Y' ORDER BY scouts.name";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $scouts_dev) or die(mysql_error());
...
<link href="css/test2table.css" rel="stylesheet" type="text/css">
<!--[if lt IE 9]>
...
<div class="container">
  ...
  <article class="content">
    <h1>Table</h1>
    <section>
     <h2>Scouts and their completed badges</h2>
...
<table width="600">
  <tbody class='tt2'>
    <tr>
      <th width="253" scope="col"><?php echo $row_Recordset1['name']; ?></th>
      <th width="335" scope="col"><?php echo $row_Recordset1['badge_name']; ?></th>
      </tr>
    </tbody>
</table>
